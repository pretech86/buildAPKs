...
then # load artifacts and libraries into the build process.
	...
	printf "\\e[1;34m%s\\n" "File ~/"${RDR##*/}"/.conf/LIBAUTH has information regarding the automation of integrating artifacts and libraries into the compilation. The functionality of this option is being enhanced. See https://github.com/BuildAPKs/buildAPKs/issues and https://github.com/BuildAPKs/buildAPKs/pulls to familiarize yourself and improve the automation of loading artifacts and libraries into compilation.  "
 	AAPTENT=""
 	ECJENT=""
	JSJCLASSPATH=""
fi
